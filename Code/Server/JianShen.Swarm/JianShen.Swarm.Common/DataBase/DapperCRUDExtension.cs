...
namespace Dapper
{
    ...
    /// </summary>
    public static partial class DapperCRUDExtension
    {

        static DapperCRUDExtension()
        {
            SetDialect(_dialect);
        }
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public static IEnumerable<T> GetListPaged<T>(this IDbConnection connection, int pageNumber, int rowsPerPage, string conditions, string orderby, out int totals, object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
